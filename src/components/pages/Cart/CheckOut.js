...
function CheckOut() {
  ...
  const handleSubmit = async () => {
    // e.preventDefault(); // Bỏ chú thích nếu cần thiết

    const selectedCartItems = JSON.parse(localStorage.getItem('selectedCartItems')) || [];
    console.log("Selected Cart Items: ", selectedCartItems); // Kiểm tra các mục đã chọn từ local storage
    ...
    console.log("Create Order Payload: ", createOrderPayload); // Kiểm tra payload trước khi gửi
